...
class MODEL_VISUAL_FEATURE_EXTRACTION(MODEL_TYPE):
    ...
    CLASSIFICATION = "classification", MODEL_VISUAL_CLASSIFICATION
    UNKNOWN = "unknown"
    
class MODEL_VISUAL(MODEL_TYPE):
    VIDEO_FEATURE_EXTRACTION = "video-feature-extraction", MODEL_VISUAL_FEATURE_EXTRACTION
