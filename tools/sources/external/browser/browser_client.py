...
class BrowserClient(ABC):
    ...
    @abstractmethod
    def extract_genres(self, sourceQuestion: SourceQuestion):
        pass
        
    @abstractmethod 
    def get_games(self, sourceQuestion: SourceQuestion, number_of_attempts: int = 3):
        pass

    @abstractmethod 
    def get_reviews(self, sourceQuestion: SourceQuestion):
        pass